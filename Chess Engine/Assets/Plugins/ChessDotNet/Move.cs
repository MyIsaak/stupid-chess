...
namespace ChessDotNet
{
    public class Move
    {
        ...
        public Move(Position originalPosition, Position newPosition, Player player)
            : this(originalPosition, newPosition, player, (Piece)null)
        { }
        ...
        public Move(Position originalPosition, Position newPosition, Player player, Transform _tr) : this(originalPosition, newPosition, player)
        {
            this._tr = _tr;
        }
